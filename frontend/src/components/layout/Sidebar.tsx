  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-64 flex-col border-r border-border bg-bg-secondary">
      ...
      <div className="flex h-16 items-center gap-3 border-b border-border px-6">
        ...
        <span className="text-lg font-bold text-white">FutureSight</span>
      </div>
      ...
      <div className="border-t border-border p-4">
        <div className="flex items-center gap-3">
          <div className="h-8 w-8 rounded-full bg-gradient-to-br from-accent-blue to-accent-purple" />
          <div>
            <p className="text-sm font-medium text-gray-200">FutureSight</p>
